...
//        container.removeAllViews();
    ...
    private void resolveToFull() {
        ...
        gsyVideoPlayer.getFullscreenButton().setImageResource(com.shuyu.gsyvideoplayer.R.drawable.video_shrink);
    ...
    private void resolveToNormal() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                gsyVideoPlayer.getFullscreenButton().setImageResource(com.shuyu.gsyvideoplayer.R.drawable.video_enlarge);
                gsyVideoPlayer.getBackButton().setVisibility(View.GONE);
                gsyVideoPlayer.setIfCurrentIsFullscreen(false);

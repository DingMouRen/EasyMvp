...
public class CustomStandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected CustomStandardGSYVideoPlayer.DismissControlViewTimerTask mDismissControlViewTimerTask;
    ...
    protected void init(Context context) {
        ...
        mLoadingProgressBar = (ENDownloadView) findViewById(com.shuyu.gsyvideoplayer.R.id.loading);
    ...
    public boolean setUp(String url, boolean cacheWithPlay, File cachePath, Object... objects) {
        if (super.setUp(url, cacheWithPlay, cachePath, objects)) {
            ...
            if (mIfCurrentIsFullscreen) {
                mFullscreenButton.setImageResource(com.shuyu.gsyvideoplayer.R.drawable.video_shrink);
            } else {
                mFullscreenButton.setImageResource(com.shuyu.gsyvideoplayer.R.drawable.video_enlarge);
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            ...
            if (mDialogProgressNormalColor != -11) {
                mDialogTotalTime.setTextColor(mContext.getResources().getColor(android.R.color.holo_red_light));
            }
            if (mDialogProgressHighLightColor != -11) {
                mDialogSeekTime.setTextColor(mContext.getResources().getColor(android.R.color.holo_red_light));
            }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            CustomStandardGSYVideoPlayer gsyVideoPlayer = (CustomStandardGSYVideoPlayer) gsyBaseVideoPlayer;
    ...
    public CustomStandardGSYVideoPlayer mSmallVideoPlayer;
    @Override
    public GSYBaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        GSYBaseVideoPlayer gsyBaseVideoPlayer = super.showSmallVideo(size, actionBar, statusBar);
        if (gsyBaseVideoPlayer != null) {
            mSmallVideoPlayer = (CustomStandardGSYVideoPlayer) gsyBaseVideoPlayer;
            mSmallVideoPlayer.setStandardVideoAllCallBack(mStandardVideoAllCallBack);
        }
        return gsyBaseVideoPlayer;
    }

    public CustomStandardGSYVideoPlayer getSmallVideoPlayer(){
        return mSmallVideoPlayer;
    }
    ...
    private void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new CustomStandardGSYVideoPlayer.DismissControlViewTimerTask();
